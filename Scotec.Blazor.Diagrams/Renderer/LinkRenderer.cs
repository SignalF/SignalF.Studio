...
namespace Scotec.Blazor.Diagrams.Renderer
{
    public class LinkRenderer : Renderer<LinkModel>
    {
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(4, "style", $"top: {top}px; left: {left}px; width: {width}px; height: {height}px; background-color: transparent;pointer-events: none;");
            ...
            builder.AddAttribute(7, "pointer-events", "all");
